...
public class App {
	...
	public static void main(String[] args) {
		try
		{
			// arguments, on attends les param�tres suivants:
			// 0 : f:chemin du fichier
			// 1 : x:num�ro de colonne du x
			// 2 : y:num�ro de colonne du y
			// 3 : color:num�ro de colonne du color
			// 4 : size:num�ro de colonne du size
			// 5 : l:librairie � utiliser Plot.ly ou Nvd3
			//
